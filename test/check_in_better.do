...
*******************************************************************************/
  ...
  * (the raw data uses different names for the same question in different rides)
  gen   CI_work = inlist("Sim", sv_looking_for_work, work_or_looking) ///
      if (!missing(work_or_looking) | !missing(sv_looking_for_work))
...
*******************************************************************************/
  ...
  iecodebook apply using "${doc_rider}/baseline-study/codebooks/check_in.xlsx", ///
      drop
